...
const Landpage_2 = () => {
  const [accorData, setaccorData] = useState([
    ...
    {
      heading:
        "How do you decide what order to list products in the comparison table?",
      para1:
          ...
          <div className="land3-section">
            <div className="land3-main d-flex ">
              <div className="land3-left-side">
                ...
                <div className="land3-img-parent">
                  <img
                    src="https://www.broadbandgenie.co.uk/img/kazaam/genie/genie-tablet.png"
                    alt=""
                    className="land3-img"
                  />
                </div>
